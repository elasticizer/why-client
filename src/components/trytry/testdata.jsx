...
const CourseList = () => {
  ...
  return (
    <div>
      ...
      {courses.map(course => (
        <div key={course.SN}
          className={`border group bg-gray rounded-xl overflow-hidden md:max-w-2xl md:flex gap-3 `}
        >

          <div className="  border md:shrink-0 relative  group-hover:scale-105 transition-transform duration-500 ease-in-out ">
