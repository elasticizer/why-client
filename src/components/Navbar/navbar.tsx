...
export default function Navbar() {
	return (
		<>
			{/* <!-- ========== HEADER ========== --> */}
			<header className="mb-0 sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 ">
				<nav className="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
					...
					<div
						...
						<div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
							<Link href="/about">
								<div className="font-medium text-gray-500 hover:text-orange-400 sm:py-6">
									關於
								</div>
							</Link>
