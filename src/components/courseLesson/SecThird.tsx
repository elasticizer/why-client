...
import NavCh from '@/components/courseLesson/NavCh';
		...
		<>
			<div className="">
				<div className="mt-8 w-full mx-2 px-0 lg:px-0 ">
					<div className="  grid lg:grid-cols-[850px_minmax(300px,_1fr)_100px] gap-x-10 ">
						{/* 左邊 */}
						<div className="pr-2">
							...
							{/* <div className="lg:hidden">
								...
								<div
									...
									<p className=" text-gray-500 font-['Inter'] leading-7  lg:pt-0  text-base  dark:text-neutral-400 ">
										意的表現，而是能夠將你的想像力轉化為真實的產品體驗。無論你是剛起步還是已經有一定經驗，這個課程都將為你打開新的視野，讓你在設計的道路上更上一層樓！趕快加入我們，成為軟硬實力兼具的產品設計師，並跟上全球最前沿的設計趨勢！
									</p>
								</div>
							...
							{/* <video/> */}
							{/* 觸發到nav就跑到另一個nav */}
							<div className="hidden sm:block  lg:sticky lg:z-50 lg:top-0 py-0  z-0  ">
								<nav
									...
									<button
										type="button"
										className="hs-tab-active:border-b-blue-600 hs-tab-active:text-gray-900 relative min-w-0 flex-1 bg-white first:border-s-0  border-b-[3px] py-4 px-4 text-gray-500 hover:text-gray-700 text-base font-semibold text-center overflow-hidden hover:bg-gray-200 focus:z-10 focus:outline-none focus:text-blue-600 disabled:opacity-50 disabled:pointer-events-none"
						...
						<div className=" lg:h-[5000px]   ">
							<div className=" sticky top-20   flex flex-col bg-white border shadow-sm rounded-xl">
