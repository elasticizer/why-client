...
export default function BannerText() {
	return (
		<>
			<div className=" place-content-center sm:items-center  lg:items-center lg:justify-center  lg:pl-20 ">
				...
				<div className="my-8  ">
					<div className="inline-block shadow-xl font-bold  text-xl bg-clip-text bg-gradient-to-l from-blue-300 to-yellow-400 text-transparent">
						<Typewriter
				...
				<div className="  flex  justify-center   sm:h-16  lg:h-40 lg:w-full ">
					<img
						className=" sm:h-15 sm:w-16 lg:h-25 lg:w-32"
						src="/img/Animation - 1715325080679.gif"
						alt=""
					/>
				</div>
			</div>
