		...
		<>
			<div className="mx-auto max-w-xl relative">
				...
				<form onSubmit={handleData}>
					<div className=" relative z-10 flex space-x-3  bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20">
				...
				{/* End Form */}
				{/* SVG Element */}
				<div className="hidden md:block absolute -top-20 end-0">
					<svg
