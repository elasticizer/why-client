        ...
        <div className="w-full h-auto p-5 border inline-flex gap-4">
            ...
            <div className="w-full inline-flex flex-col">
                ...
                <div className={`w-full flex justify-between items-center hs-collapse `}>
                    {/* <div className={`w-full flex justify-between items-center hs-collapse ${replyVisible ? '' : 'hidden'}`}> */}
                    <button
                ...
                <div
                    ...
                    // className={`hs-collapse ${replyVisible ? 'hidden' : ''} hidden w-full overflow-hidden transition-[height] duration-300`}
