	...
	return (
		<>
			...
			<div className="max-w-4xl mx-auto">
				{/* Card */}
				<div className="relative bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-800">
					<div className="mb-8">
					...
					<Filler
						data={{
							[ids.intro]: `大家好！我是一位活躍於開源領域的開發人員。我熱愛軟體開發，並致力於推廣開源軟體。\n\n我擁有多年的軟體開發經驗，曾在多個開源項目中做出貢獻。我熟悉各種開源技術，並能夠快速學習新技術。\n\n我積極參與開源社區活動，經常在開源會議上發表演講和分享經驗。我也撰寫了多篇關於開源軟體的文章，幫助他人了解和使用開源軟體。\n\n我堅信開源軟體的力量，並希望通過我的努力，讓更多的人受益於開源軟體。`
						}}
