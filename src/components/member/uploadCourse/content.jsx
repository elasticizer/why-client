...
export default function Content({ UploadFileAlertDisplay, SetUploadFileAlertDisplay, courseClass, setCourseClass, lesson, lessonData,courseProgress, setCourseProgress, SetUploadCourseAlertDisplay, setPutData, setLessonData }) {
	return (
