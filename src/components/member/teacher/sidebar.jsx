...
export default function Sidebar({ WindowNav, setWindowNav }) {
	...
	return (
		<nav
			className={`${styles.windowNav} ${WindowNav} transition-all`}
			onMouseOver={() => {
				setWindowNavFont('');
			}}
			onMouseLeave={() => {
			...
			<div className={`${styles.windowNavcontainer} md:justify-between`}>
				<div className={styles.windowNavcontainerItem}>
					...
					<Link
						href="/teacher/homeworkGrading"
						className={` hover:ps-2 hover:border-l-4 hover:border-l-red-500 hidden`}>
						<div>
							<RiPencilFill
								size="30px"
								color="#999999"
					...
					<Link
						href="/teacher/articleManagement"
						className={`${styles.windowNavItem} hover:ps-2 hover:border-l-4 hover:border-l-red-500`}>
						<div>
							<MdArticle
								size="30px"
				...
				<div className={styles.windowNavcontainerItem}>
					<Link
						href="/learner"
						className={`${styles.windowNavItem}  hover:ps-2 hover:border-l-4 hover:border-l-red-500 hidden`}>
						<div>
							<PiStudent
								size="30px"
								color="#999999"
