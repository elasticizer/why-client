		...
		<>
			<div className="w-full mb-2 flex">
				...
				<button
					...
					className="ml-2 p-2 text-sm font-semibold rounded-lg border border-transparent bg-sky-500 text-white hover:bg-sky-400 disabled:opacity-50 disabled:pointer-events-none">
					清除搜尋
				</button>
			</div>
