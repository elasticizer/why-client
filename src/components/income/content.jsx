				...
				<div className="space-y-5">
					<div className="border-b border-gray-200 dark:border-neutral-700">
						<nav
							...
							<button
								type="button"
								className="hs-tab-active:font-semibold hs-tab-active:border-orange-600 hs-tab-active:text-orange-600 py-4 px-1 inline-flex items-center gap-x-2 border-b-2 border-transparent whitespace-nowrap text-gray-500 hover:text-orange-600 focus:outline-none focus:text-orange-600 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:text-blue-500 active"
